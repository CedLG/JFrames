...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
           a--;
           if(a==0){
                JOptionPane.showMessageDialog(null,"Maximum attempts has been reached", "Login", JOptionPane.ERROR_MESSAGE);
                System.exit(0);
            }
            JOptionPane.showMessageDialog(null,"Access Denied! you can only try "+a+" more times", "Login", JOptionPane.ERROR_MESSAGE);
